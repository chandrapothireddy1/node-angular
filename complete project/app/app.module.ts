...
@NgModule({
  declarations: [
    AppComponent, MenuComponent, RegisterComponent, HomeComponent, AboutusComponent, LoginComponent, UserListComponent, EditUserComponent, disableInputDirective, CapitalPipe
  ],
  imports: [
    BrowserModule, RouterModule.forRoot(routes), FormsModule, AdminModule, HttpClientModule
  ],
